import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{D as f}from"./DicePanel-DbDlckec.js";import{A as I}from"./ActionPanel-BNX8KAzD.js";import"./Actions.module-D96rmHzj.js";import"./Button-KeV5yYt4.js";import"./PadrinoChoicePanel-CnI8xAGG.js";import"./OrcaResolutionPanel-BiHLBvC-.js";import"./SealExplosionPanel-lRriyBA4.js";function m({rolled:d,value:g,disabled:y,onRoll:p,flow:c,onChoosePadrinoAction:v,onEndTurn:b,swap:w,orca:q,seal:k,spy:D}){return a.jsxs("div",{children:[a.jsx(f,{rolled:d,value:g,disabled:y,onRoll:p}),a.jsx(I,{flow:c,onChoosePadrinoAction:v,onEndTurn:b,swap:w,orca:q,seal:k,spy:D})]})}m.__docgenInfo={description:"",methods:[],displayName:"CenterActionDock",props:{rolled:{required:!0,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]},description:""},disabled:{required:!0,tsType:{name:"boolean"},description:""},onRoll:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},flow:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  mode:
    | "waiting"
    | "roll"
    | "fish"
...
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const R=["PadrinoVisible","Hidden"];export{n as Hidden,r as PadrinoVisible,R as __namedExportsOrder,A as default};
