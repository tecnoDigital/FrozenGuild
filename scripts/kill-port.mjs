...
async function killPort() {
  try {
    // Find the PID using the port (exact match to avoid matching similar ports like 80001)
      ...
      if (listeningLine) {
        ...
        if (pid && pid !== '0') {
          ...
          try {
            ...
            console.log(`[cleanup] Could not kill process ${pid} (may have already exited)`);
          }
        }
      }
    } else {
    ...
    // Port is free or netstat failed (acceptable)
